            ...
            <div className="bg-white rounded-3xl p-8 border border-[#BD924D] shadow-[0_20px_50px_rgba(0,0,0,0.15)] flex flex-col justify-between h-full">
              <div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="bg-[#BD924D] hover:bg-[#a67e3f] text-white text-[10px] sm:text-xs font-black tracking-widest py-4 rounded-full transition-all duration-300 shadow-md hover:shadow-lg uppercase mt-2 cursor-pointer"
                  >
                    SEND MESSAGE
                  </button>
                </form>
